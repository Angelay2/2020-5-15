...
/* static修饰成员: 变量, 函数
	1. 所有对象共享static成员
	2. 访问形式: 对象, 类名::
	3. static和非static成员函数的调用: static只能调用static, 而非static无限制
	4. static成员函数没有this指针, 
	5. static成员变量只能在类外初始化, 并且不占用类的大小(内存)

*/

/*
友元类:
	1. 友元类的所有成员韩式变成另一个类的友元函数
	2. 友元关系式单方面的, 如果需要相互构成友元关系, 需要相互声明
	3. 友元关系不传递
*/
